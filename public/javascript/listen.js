...
var listen_x4y0 = firebase.database().ref('Map/x4y0');
...
var listen_x5y0 = firebase.database().ref('Map/x5y0');
...
var listen_x6y0 = firebase.database().ref('Map/x6y0');
...
var listen_x7y0 = firebase.database().ref('Map/x7y0');
...
var listen_x8y0 = firebase.database().ref('Map/x8y0');
...
var listen_x9y0 = firebase.database().ref('Map/x9y0');
...
var listen_x4y1 = firebase.database().ref('Map/x4y1');
...
var listen_x5y1 = firebase.database().ref('Map/x5y1');
...
var listen_x6y1 = firebase.database().ref('Map/x6y1');
...
var listen_x7y1 = firebase.database().ref('Map/x7y1');
...
var listen_x8y1 = firebase.database().ref('Map/x8y1');
...
var listen_x9y1 = firebase.database().ref('Map/x9y1');
...
var listen_x0y2 = firebase.database().ref('Map/x0y2');
...
var listen_x1y2 = firebase.database().ref('Map/x1y2');
...
var listen_x2y2 = firebase.database().ref('Map/x2y2');
...
var listen_x3y2 = firebase.database().ref('Map/x3y2');
...
var listen_x4y2 = firebase.database().ref('Map/x4y2');
...
var listen_x5y2 = firebase.database().ref('Map/x5y2');
...
var listen_x6y2 = firebase.database().ref('Map/x6y2');
...
var listen_x7y2 = firebase.database().ref('Map/x7y2');
...
var listen_x8y2 = firebase.database().ref('Map/x8y2');
...
var listen_x9y2 = firebase.database().ref('Map/x9y2');
...
var listen_x0y3 = firebase.database().ref('Map/x0y3');
...
var listen_x1y3 = firebase.database().ref('Map/x1y3');
...
var listen_x2y3 = firebase.database().ref('Map/x2y3');
...
var listen_x3y3 = firebase.database().ref('Map/x3y3');
...
var listen_x4y3 = firebase.database().ref('Map/x4y3');
...
var listen_x5y3 = firebase.database().ref('Map/x5y3');
...
var listen_x6y3 = firebase.database().ref('Map/x6y3');
...
var listen_x7y3 = firebase.database().ref('Map/x7y3');
...
var listen_x8y3 = firebase.database().ref('Map/x8y3');
...
var listen_x9y3 = firebase.database().ref('Map/x9y3');
...
var listen_x0y4 = firebase.database().ref('Map/x0y4');
...
var listen_x1y4 = firebase.database().ref('Map/x1y4');
...
var listen_x2y4 = firebase.database().ref('Map/x2y4');
...
var listen_x3y4 = firebase.database().ref('Map/x3y4');
...
var listen_x4y4 = firebase.database().ref('Map/x4y4');
...
var listen_x5y4 = firebase.database().ref('Map/x5y4');
...
var listen_x6y4 = firebase.database().ref('Map/x6y4');
...
var listen_x7y4 = firebase.database().ref('Map/x7y4');
...
var listen_x8y4 = firebase.database().ref('Map/x8y4');
...
var listen_x9y4 = firebase.database().ref('Map/x9y4');
...
var listen_x0y5 = firebase.database().ref('Map/x0y5');
...
var listen_x1y5 = firebase.database().ref('Map/x1y5');
...
var listen_x2y5 = firebase.database().ref('Map/x2y5');
...
var listen_x3y5 = firebase.database().ref('Map/x3y5');
...
var listen_x4y5 = firebase.database().ref('Map/x4y5');
...
var listen_x5y5 = firebase.database().ref('Map/x5y5');
...
var listen_x6y5 = firebase.database().ref('Map/x6y5');
...
var listen_x7y5 = firebase.database().ref('Map/x7y5');
...
var listen_x8y5 = firebase.database().ref('Map/x8y5');
...
var listen_x9y5 = firebase.database().ref('Map/x9y5');
...
var listen_x0y6 = firebase.database().ref('Map/x0y6');
...
var listen_x1y6 = firebase.database().ref('Map/x1y6');
...
var listen_x2y6 = firebase.database().ref('Map/x2y6');
...
var listen_x3y6 = firebase.database().ref('Map/x3y6');
...
var listen_x4y6 = firebase.database().ref('Map/x4y6');
...
var listen_x5y6 = firebase.database().ref('Map/x5y6');
...
var listen_x6y6 = firebase.database().ref('Map/x6y6');
...
var listen_x7y6 = firebase.database().ref('Map/x7y6');
...
var listen_x8y6 = firebase.database().ref('Map/x8y6');
...
var listen_x9y6 = firebase.database().ref('Map/x9y6');
...
var listen_x0y7 = firebase.database().ref('Map/x0y7');
...
var listen_x1y7 = firebase.database().ref('Map/x1y7');
...
var listen_x2y7 = firebase.database().ref('Map/x2y7');
...
var listen_x3y7 = firebase.database().ref('Map/x3y7');
...
var listen_x4y7 = firebase.database().ref('Map/x4y7');
...
var listen_x5y7 = firebase.database().ref('Map/x5y7');
...
var listen_x6y7 = firebase.database().ref('Map/x6y7');
...
var listen_x7y7 = firebase.database().ref('Map/x7y7');
...
var listen_x8y7 = firebase.database().ref('Map/x8y7');
...
var listen_x9y7 = firebase.database().ref('Map/x9y7');
...
var listen_x0y8 = firebase.database().ref('Map/x0y8');
...
var listen_x1y8 = firebase.database().ref('Map/x1y8');
...
var listen_x2y8 = firebase.database().ref('Map/x2y8');
...
var listen_x3y8 = firebase.database().ref('Map/x3y8');
...
var listen_x4y8 = firebase.database().ref('Map/x4y8');
...
var listen_x5y8 = firebase.database().ref('Map/x5y8');
...
var listen_x6y8 = firebase.database().ref('Map/x6y8');
...
var listen_x7y8 = firebase.database().ref('Map/x7y8');
...
var listen_x8y8 = firebase.database().ref('Map/x8y8');
...
var listen_x9y8 = firebase.database().ref('Map/x9y8');
...
var listen_x0y9 = firebase.database().ref('Map/x0y9');
...
var listen_x1y9 = firebase.database().ref('Map/x1y9');
...
var listen_x2y9 = firebase.database().ref('Map/x2y9');
...
var listen_x3y9 = firebase.database().ref('Map/x3y9');
...
var listen_x4y9 = firebase.database().ref('Map/x4y9');
...
var listen_x5y9 = firebase.database().ref('Map/x5y9');
...
var listen_x6y9 = firebase.database().ref('Map/x6y9');
...
var listen_x7y9 = firebase.database().ref('Map/x7y9');
...
var listen_x8y9 = firebase.database().ref('Map/x8y9');
...
var listen_x9y9 = firebase.database().ref('Map/x9y9');
